...
public class TotpUtils {
    ...
    /** 时间步长，动态口令变化时间周期(单位秒) */
    private static final int TIME_STEP = 120;
    /** 动态口令默认长度 */
    ...
    private static String generateTOTP(String secret, long currentInterval, int codeDigits) {
        ...
        byte[] hash = TotpUtils.HmacSHA1(content, secret);
     ...
     * @return
     */
    private static byte[] HmacSHA1(byte[] content, String key) {
        try {
...
//        System.out.println(generateTOTP("GAZDENDEMRQWGLJQMRTDCLJUGUZTSLLCHA4TMLJXHE2TGYZTMJSTSNRXGFHVQY3M", 6));
//        Thread.sleep(180*1000);
//        System.out.println(verify("GAZDENDEMRQWGLJQMRTDCLJUGUZTSLLCHA4TMLJXHE2TGYZTMJSTSNRXGFHVQY3M", "019772",6));
    }
}
